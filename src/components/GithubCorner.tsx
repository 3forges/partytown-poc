...
import styles from '~/components/GithubCorner.module.css';
import GithubCornerDrawer from "~/components/GithubCornerDrawer";
...
<>
  ...
  <GithubCornerDrawer isOpen={isOpen} setIsOpen={setIsOpen}/>
