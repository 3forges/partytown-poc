...
export default function LogoSVG() {
    ...
    return (
        <>
			...
			<svg fill="none" scale="2" class="h-12" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
				viewBox="600 600 1000 1000" style="enable-background:new 600 600 1000 1000;">

			<g>
				<path fill="currentColor" style="stroke: #FF5D01!important; fill: #FF5D01!important;" d="M1364.81,1054.2c-18.91-44.7-50.44-82.66-90.16-109.49c-39.7-26.84-87.7-42.53-139.18-42.52
				...
				<polygon fill="currentColor" points="910.51,1177.84 816.76,1399.47 839.15,1399.3 910.51,1230.55 981.87,1399.3 1004.24,1399.47 	"/>
				<polygon fill="currentColor" points="910.49,1072.38 771.98,1399.82 794.37,1399.65 910.49,1125.1 1026.61,1399.65 1048.97,1399.82 	"/>
				<path fill="currentColor" d="M910.48,860.71L910.48,860.71c-37.52,0-71.44,22.3-86.33,56.74L615.62,1400h133.98l140.46-332.1l11.06-26.17l9.35-22.08
